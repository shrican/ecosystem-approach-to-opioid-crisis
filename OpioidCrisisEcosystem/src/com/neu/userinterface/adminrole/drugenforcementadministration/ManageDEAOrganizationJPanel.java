 ...
 * @author Soham
 */
public class ManageDEAOrganizationJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManageDEAOrganizationJPanel
     */
    private JPanel userProcessContainer;
    private OrganizationDirectory organizationDirectory;

    public ManageDEAOrganizationJPanel(JPanel userProcessContainer, OrganizationDirectory organizationDirectory) {
        initComponents();
    ...
    private void populateCombo() {
        ...
        for (Type type : Organization.Type.values()) {
            if (!type.getValue().equals(Type.Admin.getValue())) {
                if (type.getValue().equals("DEA Organization")) {
    ...
    private void addJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addJButtonActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "New DEA organization created");
        populateTable();
